...
3. **Isocronía como Andamio Cognitivo (_Cognitive Load Theory_, Sweller; Ravignani, Max Planck Institute, 2020) [1.2.2, 1.3.1]:**
...
- **Ingeniería Inversa sobre _Partitura 1 (Félix Dumont)_:** Parseo de la estructura real exportada por MuseScore Studio 4.7.3 mediante `DOMParser` nativo en el navegador y jsdom (cero dependencias externas pesadas).
...
- **Canalización Multicanal General MIDI:**
  - **Canal 10 (Percusión GM):** Metrónomo con notas GM 76 (_High Woodblock_ - Tiempo 1 fuerte) y 77 (_Low Woodblock_ - Tiempos débiles).
