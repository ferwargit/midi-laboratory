...
### Modalidad 04: _Audiomotor Repertoire Chaining Engine_ — Versión 2.0
...
3. **Isocronía como Andamio Cognitivo (_Cognitive Load Theory_, Sweller; Ravignani, 2020) [1.2.2, 1.3.1]:**
...
4. **Percepción Rítmica Proporcional (_Inter-Onset Intervals - IOI_, Repp, 2005; Jacoby & McDermott, 2024) [1.3.2, 1.3.9]:**
...
5. **Cierre Gestáltico y Nota de Llegada (_Target Note Resolution_, Lerdahl & Jackendoff) [1.1.2, 1.4.3]:**
...
6. **Pausa de Respiración Atencional (_Attentional Reset_, $1700\text{ ms}$):**
...
Analiza la estructura de **MuseScore Studio 4.7.3** (_Partitura 1 - Dumont_):
...
- **Canalización Multicanal General MIDI:**
  - **Canal 10 (Percusión):** Metrónomo con notas GM 76 (_High Woodblock_ - Tiempo 1 fuerte) y 77 (_Low Woodblock_ - Tiempos débiles).
...
- **Interacción:** El alumno podrá hacer clic en una nota de inicio y una nota de fin directamente sobre la partitura dibujada para establecer el rango de estudio (_Deliberate Practice Chunk_).
...
- **Integración:**
  ...
  - Explicación de progresiones (ej: _"El Compás 3 modula temporalmente al V grado con bajo en 3ra ($G/B$)"_).
...
- **Transposición Tonal en Tiempo Real:** Cambiar la tonalidad de la obra al vuelo (ej: transportar _Partitura 1_ de $C$ Mayor a $G$ Mayor o $F$ Mayor) para evaluar oído relativo puro.
